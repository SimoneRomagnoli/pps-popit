...
in quanto essi incapsulano un \textit{comportamento}, il quale ben si adatta a descrivere l'effettivo comportamento
...
Analogamente, anche il pattern MVC adottato ha risentito dell'adozione di tale paradigma. Di fatto,
i componenti \texttt{Model}, \texttt{View} e \texttt{Controller} sono stati modellati come attori.