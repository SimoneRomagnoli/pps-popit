        ...
        case RenderMap(grid, track) =>
          ...
          Platform.runLater {
            ...
            grid.cells foreach { cell =>
              ...
              canvas.graphicsContext2D.fillRect(cell.x*cellSize, cell.y*cellSize, cellSize, cellSize)
            }
            track.cells.prepended(GridCell(-1, 0, RIGHT)).sliding(2).foreach { couple =>
              val name: String = couple.head.direction.toString+"-"+couple.last.direction.toString+".png"
